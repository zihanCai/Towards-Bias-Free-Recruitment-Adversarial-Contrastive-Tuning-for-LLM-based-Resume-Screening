...
def evaluate(model, data_loader, device):
    ...
    acc = accuracy_score(genders, predictions)
...
if __name__ == '__main__':
    ...
    model_name = 'model-lr-5e-05-lam-3-epoch-1'
    # model_name = 'bert_model'
    my_model_path = 'D:/wfy/code/LLM-fairness/save_model/models/contra/model-lr-5e-05-lam-3-epoch-1'
    # my_model_path = 'D:/wfy/code/LLM-fairness/train_downstream_classification/save_model/bert_model-epoch-1'
    # my_model_path = 'D:/wfy/code/LLM-fairness/train_downstream_classification/save_model/bert_model-epoch-5'
    bert_model_path = 'D:/wfy/code/model/bert_model'
    # test_model_path = "D:/wfy/code/LLM-fairness/train_downstream_classification/save_model/bert_model-downstream-epoch10"
    ...
    model = BertClassifier(path=my_model_path,num_labels=2)
    
    # model.load_state_dict(torch.load(my_model_path))
    tokenizer = BertTokenizer.from_pretrained(bert_model_path)
    model.to(device)
    model_save_path = f"D:/wfy/code/LLM-fairness/eval/leakage_test/save_model/{model_name}-downstream-epoch"
